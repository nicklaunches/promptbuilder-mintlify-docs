...
<AccordionGroup>
  ...
  <Accordion title="Library">
    Use **Save** to store the exact version you want in **My Prompts**, so you can reuse it later (and run it in Tester).
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Prompt Library" href="/features/prompt-library">
    Organize saved prompts and run them in Tester.
  </Card>
